...
def build_monitor():
    ...
    train_panel_name_map = {
        ...
        "train_safe_idle_rate": "安全期停滞率",
        "train_speedup_bias_rate": "加速增益偏好率",
    ...
    val_panel_name_map = {
        ...
        "val_safe_idle_rate": "安全期停滞率",
        "val_speedup_bias_rate": "加速增益偏好率",
    ...
    for metric in [
        ...
        "train_safe_idle_rate",
        "train_speedup_bias_rate",
